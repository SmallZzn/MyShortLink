...
import com.zhao.shorturl.admin.service.ManagerToUserService;
...
public class ManagerToUserController {
     ...
     * 创建管理员与用户关联关系
     */
    @PostMapping("/short-url/admin/v1/manager-to-user")
     ...
     * 删除管理员与用户关联关系
     */
    @PostMapping("/short-url/admin/v1/manager-to-user/delete")
     ...
     * 根据管理员名称查询关联的用户列表
     */
    @GetMapping("/short-url/admin/v1/manager-to-user/manager/{managerName}")
     ...
     * 根据用户名称查询关联的管理员列表
     */
    @GetMapping("/short-url/admin/v1/manager-to-user/user/{userName}")
     ...
     * 分页查询管理员与用户关联关系列表
     */
    @GetMapping("/short-url/admin/v1/manager-to-user/page")
     ...
     * 查询管理员与用户关联关系列表
     */
    @GetMapping("/short-url/admin/v1/manager-to-user/list")
     ...
     * 查询分配列表
     */
    @PostMapping("/short-url/admin/v1/manager-to-user/getAssignedList")
     ...
     * 分页查询管理的用户列表
     */
    @GetMapping("/short-url/admin/v1/manager-to-user/pageUserList")
     ...
     * 查看管理员管理的短链接
     */
    @PostMapping("/short-url/v1/manager-to-user/getManagerShortLink")
     ...
     * 查看用某一用户指定时间内访问曲线
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsAccess")
     ...
     * 查看用某一用户指定时间内访问地区分布
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsArea")
     ...
     * 查看用某一用户指定时间内24小时分布
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsHours")
     ...
     * 查看用某一用户指定时间一周分布
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsWeek")
     ...
     * 查看用某一用户指定时间内访问用户信息
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsUser")
     ...
     * 查看用某一用户指定时间内访问记录
     */
    @PostMapping("/short-url/v1/manager-to-user/groupShortLinkStatsRecord")
     ...
     * 获取基础统计信息
     */
    @GetMapping("/short-url/v1/manager-to-user/groupShortLinkStatsRecord")

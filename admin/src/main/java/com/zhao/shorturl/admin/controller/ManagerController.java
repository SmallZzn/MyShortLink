...
public class ManagerController {
     ...
     * 根据用户名查询管理员信息
     */
    @GetMapping("/short-url/admin/v1/manager/{username}")
     ...
     * 查询用户名是否存在
     */
    @GetMapping("/short-url/admin/v1/manager/has-username")
     ...
     * 创建管理员
     */
    @PostMapping("/short-url/admin/v1/manager")
     ...
     * 更新管理员信息
     */
    @PutMapping("/short-url/admin/v1/manager")
     ...
     * 删除管理员
     */
    @DeleteMapping("/short-url/admin/v1/manager")
     ...
     * 分页查询管理员列表
     */
    @GetMapping("/short-url/admin/v1/manager/page")
     ...
     * 登录
     */
    @PostMapping("/short-url/admin/v1/manager/login")
     ...
     * 检查用户是否登录
     */
    @GetMapping("/short-url/admin/v1/manager/check-login")

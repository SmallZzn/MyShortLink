package com.zhao.shortlink.admin.remote;
...
public interface ShortLinkActualRemoteService {
     ...
     * @return 网站标题
     */
    @GetMapping("/short-link/v1/title")
     ...
     * @return 短链接监控信息
     */
    @GetMapping("/short-link/v1/stats")
     ...
     * @return 分组短链接监控信息
     */
    @GetMapping("/short-link/v1/stats/group")
     ...
     * @return 短链接监控访问记录信息
     */
    @GetMapping("/short-link/v1/stats/access-record")
     ...
     */
    @GetMapping("/short-link/v1/stats/access-record/group")

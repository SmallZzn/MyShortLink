...
package com.zhao.shortlink.admin.common.biz.user;
...
import com.zhao.shortlink.admin.config.UserFlowRiskControlConfiguration;
...
import static com.zhao.shortlink.admin.common.convention.errorcode.BaseErrorCode.FLOW_LIMIT_ERROR;
...
public class UserFlowRiskControlFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain filterChain) throws IOException, ServletException {
        ...
        // 设置返回参数类型，设置为integer会报错
        redisScript.setResultType(Long.class);
        // 设置用户名
        String username = Optional.ofNullable(UserContext.getUsername()).orElse("other");
        Long result = null;
        try {
            // 执行lua脚本，这里使用Lists.newArrayList(username)将username转化为list是因为形参就是list类型

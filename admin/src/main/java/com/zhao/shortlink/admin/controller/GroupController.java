...
import com.zhao.shortlink.admin.dto.req.ShortLinkGroupSaveReqDTO;
...
public class GroupController {
     ...
     * 新增短链接分组
     */
    @PostMapping("/short-link/admin/v1/group")
     ...
     * 查询短链接分组集合
     */
    @GetMapping("/short-link/admin/v1/group")
     ...
     * 修改短链接分组名称
     */
    @PutMapping("/short-link/admin/v1/group")
     ...
     * 删除短链接分组
     */
    @DeleteMapping("/short-link/admin/v1/group")
     ...
     * 排序短链接分组
     */
    @PostMapping("/short-link/admin/v1/group/sort")

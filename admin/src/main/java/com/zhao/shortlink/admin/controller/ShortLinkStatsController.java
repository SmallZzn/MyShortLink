...
import com.zhao.shortlink.admin.remote.dto.req.ShortLinkGroupStatsAccessRecordReqDTO;
import com.zhao.shortlink.admin.remote.dto.req.ShortLinkGroupStatsReqDTO;
...
public class ShortLinkStatsController {
     ...
     * 访问单个短链接指定时间内监控数据
     */
    @GetMapping("/short-link/admin/v1/stats")
     ...
     * 访问分组短链接指定时间内监控数据
     */
    @GetMapping("/short-link/admin/v1/stats/group")
     ...
     */
    @GetMapping("/short-link/admin/v1/stats/access-record")
     ...
     */
    @GetMapping("/short-link/admin/v1/stats/access-record/group")

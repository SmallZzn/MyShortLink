...
package com.zhao.shorturl.project.mq.consumer;
...
import com.zhao.shorturl.project.common.convention.exception.ServiceException;
import com.zhao.shorturl.project.dao.entity.*;
import com.zhao.shorturl.project.dao.mapper.*;
import com.zhao.shorturl.project.dto.biz.ShortLinkStatsRecordDTO;
import com.zhao.shorturl.project.mq.idempotent.MessageQueueIdempotentHandler;
...
import static com.zhao.shorturl.project.common.constant.RedisKeyConstant.LOCK_GID_UPDATE_KEY;
import static com.zhao.shorturl.project.common.constant.ShortLinkConstant.AMAP_REMOTE_URL;
...
public class ShortLinkStatsSaveConsumer implements RocketMQListener<Map<String, String>> {
    ...
    @Value("${short-url.stats.locale.amap-key}")

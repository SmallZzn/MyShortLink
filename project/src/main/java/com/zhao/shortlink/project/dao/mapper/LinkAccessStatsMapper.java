...
package com.zhao.shortlink.project.dao.mapper;

import com.baomidou.mybatisplus.core.mapper.BaseMapper;
import com.zhao.shortlink.project.dao.entity.LinkAccessStatsDO;
...
public interface LinkAccessStatsMapper extends BaseMapper<LinkAccessStatsDO> {
     ...
     * 查看用某一用户指定时间内访问曲线
     */
    List<LinkAccessStatsDO> listStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);

    /**
     * 查看用某一用户指定时间内24小时分布
     */
    List<LinkAccessStatsDO> listHourStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);

    /**
     * 查看用某一用户指定时间一周分布
     */
    List<LinkAccessStatsDO> listWeekdayStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
    ...
    @Select("SELECT " +
            ...
            "GROUP BY " +
            "   date;")
    List<LinkAccessStatsDO> listStats(@Param("param") ShortLinkStatsReqDTO requestParam);
}

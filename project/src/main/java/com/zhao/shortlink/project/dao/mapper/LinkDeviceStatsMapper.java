...
import com.zhao.shortlink.project.dao.entity.LinkDeviceStatsDO;
...
public interface LinkDeviceStatsMapper extends BaseMapper<LinkDeviceStatsDO> {
     ...
     * @return
     */
    List<LinkDeviceStatsDO> listDeviceStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
}

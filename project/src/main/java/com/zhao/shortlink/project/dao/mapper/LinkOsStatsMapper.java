...
import com.zhao.shortlink.project.dao.entity.LinkOsStatsDO;
...
public interface LinkOsStatsMapper extends BaseMapper<LinkOsStatsDO> {
     ...
     * @return
     */
    List<HashMap<String, Object>> listOsStatsByByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
}

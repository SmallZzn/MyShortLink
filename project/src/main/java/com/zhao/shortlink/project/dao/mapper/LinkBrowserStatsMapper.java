...
import com.zhao.shortlink.project.dao.entity.LinkBrowserStatsDO;
...
public interface LinkBrowserStatsMapper extends BaseMapper<LinkBrowserStatsDO> {
     ...
     * @return
     */
    List<HashMap<String, Object>> listBrowserStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
}

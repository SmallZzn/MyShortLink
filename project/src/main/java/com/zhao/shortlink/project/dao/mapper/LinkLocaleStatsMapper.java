...
import com.zhao.shortlink.project.dao.entity.LinkLocaleStatsDO;
...
public interface LinkLocaleStatsMapper extends BaseMapper<LinkLocaleStatsDO> {
     ...
     * 查看用某一用户指定时间内访问曲线
     */
    List<LinkLocaleStatsDO> listLocaleByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
}

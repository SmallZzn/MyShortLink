...
import com.zhao.shortlink.project.dao.entity.LinkNetworkStatsDO;
...
public interface LinkNetworkStatsMapper extends BaseMapper<LinkNetworkStatsDO> {
     ...
     * @return
     */
    List<LinkNetworkStatsDO> listNetworkStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
}

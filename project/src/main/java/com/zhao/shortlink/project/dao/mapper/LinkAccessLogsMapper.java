...
public interface LinkAccessLogsMapper extends BaseMapper<LinkAccessLogsDO> {
    ...
    /**
     * 根据分组id集合获取指定日期内PV、UV、UIP数据
     */
    LinkAccessStatsDO findPvUvUidStatsByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
     ...
     * @return
     */
    List<HashMap<String, Object>> listTopIpByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);
     ...
     * @return
     */
    List<HashMap<String, Object>> findUvTypeCntByGidList(@Param("param") ShortLinkStatsReqDTO requestParam);

//    /**
//     * 根据获取指定日期内PV、UV、UIP数据
//     */
//    @Select("SELECT " +
//            "    COUNT(user) AS pv, " +
//            "    COUNT(DISTINCT user) AS uv, " +
